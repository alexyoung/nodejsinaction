...
var OptionManager = (function () {
  ...
  OptionManager.memoisePluginContainer = function memoisePluginContainer(fn, loc, i, alias) {
    for (var _iterator = OptionManager.memoisedPlugins, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _getIterator(_iterator);;) {
      var _ref;
    ...
    if (typeof obj === "object") {
      var plugin = new _plugin2["default"](obj, alias);
  ...
  OptionManager.normalisePlugin = function normalisePlugin(plugin, loc, i, alias) {
    ...
    if (!(plugin instanceof _plugin2["default"])) {
  ...
  OptionManager.prototype.mergeOptions = function mergeOptions(_ref2) {
    ...
    var opts = _lodashLangCloneDeep2["default"](rawOpts, function (val) {
      if (val instanceof _plugin2["default"]) {
        return val;
      }
    });
    ...
    for (var key in opts) {
      ...
      if (!option && this.log) {
        ...
        if (_removed2["default"][key]) {
          this.log.error("Using removed Babel 5 option: " + alias + "." + key + " - " + _removed2["default"][key].message, ReferenceError);
        } else {
