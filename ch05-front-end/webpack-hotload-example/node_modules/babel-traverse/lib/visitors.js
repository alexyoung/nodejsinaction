...
function explode(visitor) {
  ...
  // add type wrappers
  for (var _iterator2 = _Object$keys(visitor), _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _getIterator(_iterator2);;) {
    var _ref2;
    ...
    if (wrapper.types) {
      for (var _iterator3 = wrapper.types, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _getIterator(_iterator3);;) {
        var _ref3;
